...
const Contact = () => {
  ...
  return (
    <>
      <Grid container p={10} justifyContent="space-evenly">
        <Grid item xs={12} md={6} display="flex" flexDirection="column" gap={3}>
          <Grid container gap={3}>
            ...
            <Typography variant="h5">
              ...
              putem telefona, email-a ili popunjavanjem forme.
            </Typography>
            <Typography variant="h5">
          ...
          <Grid container flexDirection="column">
            <Typography variant="h5">🏡 Šajkaška 54, Novi Sad</Typography>
            <Typography variant="h5">📞 0642544579</Typography>
            <Typography variant="h5">📧 rodjendaonica@woodyland.rs</Typography>
            <Typography variant="h5">📸 woody__playandlearn</Typography>
          </Grid>
        </Grid>
            ...
            {state.succeeded ? (
              ...
              <form onSubmit={handleSubmit}>
                <Grid container p={3} spacing={1}>
                  <Grid item xs={12}>
                    <Typography variant="h4">Kontakt Forma</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <TextField
                      variant="outlined"
